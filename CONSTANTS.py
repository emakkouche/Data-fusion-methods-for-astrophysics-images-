...
SAVE2 = '/media/e.akkouche/DONNEES/Fusion_data/result_sobolev_12_09_Mfft/'
SAVE_IMG = '/media/e.akkouche/DONNEES/Fusion_data/result_img_12_09_Mfft/mu_best'
# SAVE_IMG = '/media/e.akkouche/DONNEES/Fusion_data/dash/'
PSF = DATA+'PSF/'
